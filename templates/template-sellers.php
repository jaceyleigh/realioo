...
?>
	...
	<div id="primary" class="content-area sellers-page">
      ...
      <section class="hero bd-masthead" id="content" role="main">
        <div class="container">
          <div class="row align-items-center pad-50-top">
			...
			<section class="module_4 purple-bg pad-100">
				<div class="container ">
					<div class="row">
			...
			<section class="module_5 pad-100">
				<div class="container">
					...
					<div class="pricing-columns text-center pad-30-top">
						...
						<!-- point 2 -->
						<div class="point pad-30">
							<h3>Sold with an average agent gets you <b>98%</b> of list price</h3>
							<div class="row">
								<div class="col-6">
									<h2>$245,000</h2>
								</div>
						...
						<!-- point 3 -->
						<div class="point pad-30">
								<h3>SOLD with a Realioo agent gets you <b>103%</b> list price</h3>
							<div class="row">
								<div class="col-6">
									<h2>$257,000</h2>
								</div>
